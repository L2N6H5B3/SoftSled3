...
import net.propero.rdp.rdp5.mcx.AvCtrlChannel;
import net.propero.rdp.rdp5.mcx.DevCapsChannel;
import net.propero.rdp.rdp5.mcx.McxSessChannel;
...
public class Rdesktop {
	...
	public static void main(String[] args) throws RdesktopException {
		...
		McxSessChannel mcxsessChannel  = new McxSessChannel();
		DevCapsChannel devcapsChannel  = new DevCapsChannel();
		AvCtrlChannel avctrlChannel  = new AvCtrlChannel();
		...
		if (Options.use_rdp5) {
			...
			channels.register(mcxsessChannel);
			channels.register(devcapsChannel);
			channels.register(avctrlChannel);
		}
