...
public abstract class RdpPacket {
	 ...
	 *            Length of data to be copied
	 */
	public abstract void copyRemainderToByteArray(byte[] array);
	...
	public abstract byte[] getLittleEndianVariable(int length);
	
	public abstract byte[] getBigEndianVariable(int length);
